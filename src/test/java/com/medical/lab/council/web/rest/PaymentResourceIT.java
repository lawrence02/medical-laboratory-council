...
import static com.medical.lab.council.domain.PaymentAsserts.*;
...
import com.medical.lab.council.domain.Payment;
import com.medical.lab.council.repository.PaymentRepository;
...
class PaymentResourceIT {
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.registrationNumber(UPDATED_REGISTRATION_NUMBER).amount(UPDATED_AMOUNT);
