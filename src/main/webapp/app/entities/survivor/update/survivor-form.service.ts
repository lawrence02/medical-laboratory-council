...
type SurvivorFormGroupContent = {
  ...
  practitionerType: FormControl<ISurvivor['practitionerType']>;
  ...
  areaOfEmployment: FormControl<ISurvivor['areaOfEmployment']>;
  employmentStatus: FormControl<ISurvivor['employmentStatus']>;
  typeOfInstitution: FormControl<ISurvivor['typeOfInstitution']>;
  provinceEmployed: FormControl<ISurvivor['provinceEmployed']>;
...
export class SurvivorFormService {
  createSurvivorFormGroup(survivor: SurvivorFormGroupInput = { id: null }): SurvivorFormGroup {
    ...
    return new FormGroup<SurvivorFormGroupContent>({
      ...
      practitionerType: new FormControl(survivorRawValue.practitionerType),
      ...
      areaOfEmployment: new FormControl(survivorRawValue.areaOfEmployment),
      employmentStatus: new FormControl(survivorRawValue.employmentStatus),
      typeOfInstitution: new FormControl(survivorRawValue.typeOfInstitution),
      provinceEmployed: new FormControl(survivorRawValue.provinceEmployed),
