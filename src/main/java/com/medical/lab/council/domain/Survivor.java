...
public class Survivor implements Serializable {
    ...
    public Survivor practitionerType(PractitionerType practitionerType) {
    ...
    public Survivor areaOfEmployment(AreaOfEmployment areaOfEmployment) {
    ...
    public Survivor employmentStatus(EmploymentStatus employmentStatus) {
    ...
    public Survivor typeOfInstitution(TypeOfInstitution typeOfInstitution) {
    ...
    public Survivor provinceEmployed(Province provinceEmployed) {
